  ...
  return (
    <div>
      ...
      {taxIncentives.base_credit === undefined ? clicked &&
        <div className="border-r border-l border-gray-outline border-b rounded-b-lg px-4 lg:px-8 py-4" >{taxIncentives.content}</div> : clicked &&
      <div className="border-r border-l border-gray-outline border-b rounded-b-lg">
        ...
        />
        <div className="mb-4 px-4 mx-2 lg:mx-4 flex flex-col items-start self-stretch rounded-md bg-light-gray">
          <div>
