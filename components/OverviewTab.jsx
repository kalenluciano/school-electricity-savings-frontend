...
const OverviewTab = ({ overview, calculatedSavings, relevantStats, savingsImageSrc }) => {
  ...
  return (
    <div className="mt-6">
      <div className="flex items-start self-stretch gap-x-4">
        ...
        <Image src={savingsImageSrc} alt="" width={280} height={170} className="w-72 h-44 object-contain object-center" />
      </div>
